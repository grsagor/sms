...
class ScienceController extends Controller
{
    ...
    {
        return view('backend.pages.facilities.science.index');
    }
    ...
    public function getList()
    {
        ...
        $data = File::whereIn('type', array_keys($types))->get();
        ...
        return DataTables::of($data)
            ...
            ->editColumn('type', function ($row) use ($types) {
    ...
    public function edit(Request $request)
    {
        ...
        return view('backend.pages.facilities.science.edit', $data);
    }
