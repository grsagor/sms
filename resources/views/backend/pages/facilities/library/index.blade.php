...
@section('title', 'Library | ' . Helper::getSettings('application_name') ?? 'ABM')
@section('css')
    <link rel="stylesheet" href="{{ asset('assets/vendor/tagsinput/tagsinput.css') }}">
@endsection
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Library Management</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Library Image List</h5>
                        </div>
    ...
    @include('backend.pages.facilities.library.modal')
    @push('footer')
        ...
        <script type="text/javascript">
            function getArtist() {
                var table = jQuery('#dataTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('admin.facilities.library.get.list') }}",
                        type: 'GET',
                    },
                    aLengthMenu: [
            ...
            $(document).on('click', '#addPartnerBtn', function(e) {
                ...
                if (go_next_step == true) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.facilities.library.store') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $(document).on('click', '.edit_btn', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.facilities.library.edit') }}",
                    type: "GET",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '#editPartnerBtn', function(e) {
                ...
                if (go_next_step == true) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.facilities.library.update') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.facilities.library.delete') }}",
                            type: "GET",
                            data: {
                                id: id
                            },
