<form id="partnerEditForm" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Why</h5>
            ...
            <div class="step step_1 tab-pane fade show active create-artist">
                <div class="d-flex gap-1 mb-1 w-100">
                    <div class="form-floating mb-1 w-100">
                        <input type="text" class="form-control" placeholder="Title"
                            value="{{ $why->title }}" name="title">
                        <label for="">Title<span class="text-danger">*</span></label>
                    </div>
                </div>
                <div class="d-flex gap-1 mb-1 w-100">
                    <div class="form-floating mb-1 w-100">
                        <textarea type="text" class="form-control h-auto" name="description" value="{{ $why->description }}" placeholder="Description" rows="5" required>{{ $why->description }}</textarea>
                ...
                <div class="d-flex w-100 gap-2 mb-1">
                    <div class="form-group mb-1 w-100">
                        ...
                        <img src="{{ $why->image ? asset($why->image) : asset('assets/img/no-img.jpg') }}" height="80px" width="100px"
