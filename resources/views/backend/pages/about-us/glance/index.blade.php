...
@section('title', 'Glance | ' . Helper::getSettings('application_name') ?? 'ABM')
@section('css')
    <link rel="stylesheet" href="{{ asset('assets/vendor/tagsinput/tagsinput.css') }}">
@endsection
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Glance Management</h4>
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Glance Image List</h5>
                        </div>
        ...
        <div class="card my-2">
                ...
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        ...
                        @if (Helper::hasRight('menu.create'))
                                ...
                                data-key="application_glance"><i class="fa-solid fa-plus"></i>
            ...
            <div class="card-body">
                <p id="setting-text-container">
                    {!! nl2br(Helper::getSettings('application_glance') ? Helper::getSettings('application_glance') : 'No text added.') !!}
                </p>
            </div>
        </div>
    </div>
    @include('backend.pages.about-us.glance.modal')
    @push('footer')
        ...
        <script type="text/javascript">
            function getArtist() {
                var table = jQuery('#dataTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('admin.about.us.glance.get.list') }}",
                        type: 'GET',
                    },
                    aLengthMenu: [
            ...
            $(document).on('click', '#addPartnerBtn', function(e) {
                ...
                if (go_next_step == true) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.about.us.glance.store') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $(document).on('click', '.edit_btn', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.about.us.glance.edit') }}",
                    type: "GET",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '#editPartnerBtn', function(e) {
                ...
                if (go_next_step == true) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.about.us.glance.update') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.about.us.glance.delete') }}",
                            type: "GET",
                            data: {
                                id: id
                            },
