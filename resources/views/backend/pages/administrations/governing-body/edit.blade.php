<form id="partnerEditForm" method="post" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="id" value="{{ $governing_body->id }}">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Governing Body</h5>
        ...
        <div class="col-sm-12 tab-content" id="v-pills-tabContent">
            <div class="step step_1 tab-pane fade show active create-artist">
                <div class="d-flex gap-1 mb-1 w-100">
                    <div class="form-floating mb-1 w-100">
                        <input type="text" class="form-control" placeholder="Title"
                            value="{{ $governing_body->name }}" name="name">
                ...
                <div class="d-flex gap-1 mb-1 w-100">
                    <div class="form-floating mb-1 w-100">
                        <input type="text" class="form-control" placeholder="Title"
                            value="{{ $governing_body->designation }}" name="designation">
                ...
                <div class="d-flex w-100 gap-2 mb-1">
                    <div class="form-group mb-1 w-100">
                        ...
                        <img src="{{ $governing_body->image ? asset($governing_body->image) : asset('assets/img/no-img.jpg') }}" height="80px" width="100px"
