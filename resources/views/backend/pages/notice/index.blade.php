...
@section('title', 'Notice | ' . Helper::getSettings('application_name') ?? 'ABM')
@section('css')
    <link rel="stylesheet" href="{{ asset('assets/vendor/tagsinput/tagsinput.css') }}">
@endsection
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Notice Management</h4>
        ...
        <script type="text/javascript">
            function getArtist() {
                var table = jQuery('#dataTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('admin.notice.get.list') }}",
                        type: 'GET',
                    },
                    aLengthMenu: [
